...
public strictfp class Elvis extends Tower {
    ...
    public Changelog getChangelog() {
        return new Changelog(
                new ChangelogEntry(Sim.vRoCEnd, false, 2021, "Slow duration increased from 0.01 to 0.03s / level."),
                new ChangelogEntry(Sim.vDoLEnd, false, 2020, "Aura range is always the same as Elvis' range."),
