...
public strictfp class TheRipper extends Tower {
    ...
    public Changelog getChangelog() {
        return new Changelog(
                new ChangelogEntry(Sim.vDoLEnd, false, 2020, "Killing Spree speed bonus increased from 100% to 160%.", "Killing Spree speed bonus per level increased from 2% to 3%."),
