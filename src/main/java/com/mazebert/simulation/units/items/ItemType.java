...
import com.mazebert.simulation.units.items.prophecies.*;
...
public strictfp enum ItemType implements CardType<Item> {
    ...
    BuildTowerWithBloodProphecy(92, BuildTowerWithBloodProphecy.class),
    BossToMassProphecy(93, BossToMassProphecy.class),
    MassToBossProphecy(94, MassToBossProphecy.class),
    UnlockThorProphecy(95, UnlockThorProphecy.class),
    UnlockLokiProphecy(96, UnlockLokiProphecy.class),
    UnlockHelProphecy(97, UnlockHelProphecy.class),
    UnlockIdunProphecy(98, UnlockIdunProphecy.class),
    ;
