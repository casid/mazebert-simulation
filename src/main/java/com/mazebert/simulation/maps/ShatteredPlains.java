...
public strictfp class ShatteredPlains extends Map {
    public ShatteredPlains() {
        setMaxScrollY(-340);
        setMinScrollY(-1200);
        ...
        // Non-flyable water tiles
        TileType t15 = new TileType("water-1", 80f / 155f, 40f / 85f).water().notFlyable(); // For 2
        TileType t16 = new TileType("water-1", 80f / 155f, 40f / 85f).transparentWater().notFlyable(); // For 7
        ...
        addTile(new Tile(t9, -0.4f, -100));
        addTile(new Tile(t2, -0.4f, -100));
        addTile(new Tile(t10));
        addTile(new Tile(t7, -0.4f)); // Border water tile
        addTile(new Tile(t2, -0.4f, -100));
        addTile(new Tile(t2, -0.4f, -100));
        addTile(new Tile(t2, -0.4f, -100));
        ...
        addTile(new Tile(t10, 0.25f).aura(MapAura.IncreasedRange));
        addTile(new Tile(t1, 0.5f));
        addTile(new Tile(t11, 1.0f));
        ...
        addTile(new Tile(t3));
        addTile(new Tile(t12));
        addTile(new Tile(t16, -0.4f)); // Border water tile
        ...
        addTile(new Tile(t5).waypoint(1));
        addTile(new Tile(t7, -0.4f)); // Border water tile
        addTile(new Tile(t15, -0.4f, -100));
        addTile(new Tile(t13));
        addTile(new Tile(t3));
        addTile(new Tile(t3));
        addTile(new Tile(t12));
        ...
        addTile(new Tile(t2, -0.4f, -100));
        addTile(new Tile(t2, -0.4f, -100));
        addTile(new Tile(t1).aura(MapAura.IncreasedRange));
        addTile(new Tile(t16, -0.4f)); // Border water tile
        addTile(new Tile(t6));
        addTile(new Tile(t3));
        addTile(new Tile(t3));
